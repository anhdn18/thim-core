...
class Thim_Getting_Started extends Thim_Admin_Sub_Page {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script( 'thim-importer', THIM_CORE_ADMIN_URI . '/assets/js/importer/importer.js', array(
            'wp-util',
            'jquery',
            'backbone',
            'underscore'
        ) ,THIM_CORE_VERSION);
        wp_enqueue_script( 'thim-getting-started', THIM_CORE_ADMIN_URI . '/assets/js/getting-started/getting-started-v2.js', array(
            'thim-plugins',
            'thim-importer',
            'thim-video-youtube'
        ),THIM_CORE_VERSION );
